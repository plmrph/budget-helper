...
class Metadata(object):
    ...
    def __init__(self, id = None, type = None, value = None, sourceSystem = None, description = None,):
        self.id = id
        self.type = type
        self.value = value
...
class ConfigValue(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        ...
                        self.stringList.append(_elem12)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.stringMap is not None:
            ...
            for kiter21, viter22 in self.stringMap.items():
...
class ModelCard(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i27 in range(_size23):
                        ...
                        self.performanceMetrics[_key28] = _val29
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.performanceMetrics is not None:
            ...
            for kiter30, viter31 in self.performanceMetrics.items():
...
class Transactions(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i36 in range(_size32):
                        _elem37 = Transaction()
                        _elem37.read(iprot)
                        self.transactions.append(_elem37)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i42 in range(_size38):
                        ...
                        self.transactionIds.append(_elem43)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.transactions is not None:
            ...
            for iter44 in self.transactions:
                iter44.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.transactionIds is not None:
            ...
            for iter45 in self.transactionIds:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i50 in range(_size46):
                        ...
                        _val52 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
