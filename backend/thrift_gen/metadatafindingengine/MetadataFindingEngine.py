...
class Iface(object):
    def getMetadataCandidates(self, transactions, filter):
        """
        Parameters:
         - transactions
         - filter
...
class Client(Iface):
    ...
    def getMetadataCandidates(self, transactions, filter):
        ...
        """
        self.send_getMetadataCandidates(transactions, filter)
        return self.recv_getMetadataCandidates()

    def send_getMetadataCandidates(self, transactions, filter):
        self._oprot.writeMessageBegin('getMetadataCandidates', TMessageType.CALL, self._seqid)
        args = getMetadataCandidates_args()
    ...
    def recv_getMetadataCandidates(self):
        iprot = self._iprot
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            raise x
        result = getMetadataCandidates_result()
        result.read(iprot)
        iprot.readMessageEnd()
        ...
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getMetadataCandidates failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {}
        self._processMap["getMetadataCandidates"] = Processor.process_getMetadataCandidates
    ...
    def process_getMetadataCandidates(self, seqid, iprot, oprot):
        args = getMetadataCandidates_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getMetadataCandidates_result()
        try:
            result.success = self._handler.getMetadataCandidates(args.transactions, args.filter)
        ...
        oprot.writeMessageBegin("getMetadataCandidates", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class getMetadataCandidates_args(object):
    """
    Attributes:
     - transactions
     - filter
    ...
    def __init__(self, transactions = None, filter = None,):
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('getMetadataCandidates_args')
...
all_structs.append(getMetadataCandidates_args)
getMetadataCandidates_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'transactions', [thrift_gen.entities.ttypes.Transactions, None], None, ),  # 1
    (2, TType.STRUCT, 'filter', [MetadataFilter, None], None, ),  # 2
)


class getMetadataCandidates_result(object):
    """
    Attributes:
     - success
     - notFound
    ...
    def __init__(self, success = None, notFound = None, validationError = None, internalError = None, unauthorized = None, remoteError = None,):
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getMetadataCandidates_result')
        ...
        if self.remoteError is not None:
            oprot.writeFieldBegin('remoteError', TType.STRUCT, 5)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMetadataCandidates_result)
getMetadataCandidates_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [MetadataCandidate, None], False), None, ),  # 0
    ...
    (5, TType.STRUCT, 'remoteError', [thrift_gen.exceptions.ttypes.RemoteServiceException, None], None, ),  # 5
)
