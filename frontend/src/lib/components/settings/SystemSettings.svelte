...
<script>
  ...
  function updateSetting(key, value, type = "System", description = "") {
            ...
            <div class="flex items-center">
              <input
                ...
                onchange={() => {
                  ...
                  updateSetting(SYSTEM_KEYS.SELECTED_BUDGET_ID, budget.id, 'System', 'Selected budget ID');
                }}
        ...
        <div class="space-y-2">
          ...
          <Input
            ...
            oninput={(e) => {
              ...
              updateSetting(SYSTEM_KEYS.MAX_TRANSACTIONS_TO_LOAD, num, "System", "Max transactions to load");
